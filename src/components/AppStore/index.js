...
class AppStore extends Component {
  ...
  getFilteredApps = searcResults => {
    const {activeTabId} = this.state
    const filteredApps = searcResults.filter(
      filterApp => filterApp.category === activeTabId,
    )
    return filteredApps
  }
  ...
  getSearchedResults = () => {
    ...
    const searcResults = appsList.filter(eachApp =>
  ...
  render() {
    ...
    const searcResults = this.getSearchedResults()
    const filteredApps = this.getFilteredApps(searcResults)
